...
load('TF1_2d_10.mat'); % training samples Branin-Hoo function
load('TF1_2d_5000_te.mat'); % testing samples Branin-Hoo function
...
ub = 4*ones(1, size(trX{1}, 2)); % The upper bound of the correlation parameters
theta0 = 2*ones(1, size(trX{1}, 2)); % The initial values of the correlation parameters
